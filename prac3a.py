...
class prac3a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/andresr/comm2_A1_G3/A1-G3/sonido.wav', True)
        ...
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_GAUSSIAN, 0, 76)
        ...
        self.connect((self.blocks_wavfile_source_0, 0), (self.digital_binary_slicer_fb_0, 0))
