...
import test1_epy_block_0 as epy_block_0  # embedded python block
...
class test1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((1.0, 2.0, 4.0, 7.0, 11.0, 16.0, 22.0,16.0, 11.0, 7.0, 4.0, 2.0), True, 1, [])
