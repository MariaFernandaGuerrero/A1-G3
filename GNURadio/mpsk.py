...
import math
import mpsk_epy_block_0_0_0 as epy_block_0_0_0  # embedded python block
...
class mpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        labels = ['Phase', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
            'Signal 6', 'Signal 7', 'Signal 8', 'Signal 9', 'Signal 10']
        widths = [2, 1, 1, 1, 1,
            1, 1, 1, 1, 1]
        colors = ['blue', 'red', 'green', 'black', 'cyan',
        ...
        labels = ['Binary stream', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
            'Signal 6', 'Signal 7', 'Signal 8', 'Signal 9', 'Signal 10']
        widths = [2, 1, 1, 1, 1,
            1, 1, 1, 1, 1]
        colors = ['blue', 'red', 'green', 'black', 'cyan',
        ...
        self.blocks_pack_k_bits_bb_0 = blocks.pack_k_bits_bb(Nb)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.epy_block_0_0_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.epy_block_0_0_0, 1))
        ...
        self.connect((self.epy_block_0_0_0, 0), (self.interp_fir_filter_xxx_0, 0))
        self.connect((self.epy_block_0_0_0, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.epy_block_0_0_0, 0), (self.qtgui_time_sink_x_0_1_0, 0))
